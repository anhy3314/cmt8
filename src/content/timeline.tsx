...
export const TimelineContents: TimelineContent[] = [
    ...
    {
        date: '18/8/1945',
        content: `Khởi nghĩa giành chính quyền tại các tỉnh lỵ Bắc Giang, Hải Dương, Hà Tĩnh, Quảng Nam. Tại Bắc Giang, ngày 18/8 tỉnh lỵ Bắc Giang (phủ Lạng Thương) giành chính quyền; ngày 19/8 châu Yên Dũng giành chính quyền.\n
    ...
    {
        date: '19/8/1945',
        content: `Tổng khởi nghĩa giành chính quyền ở Hà Nội và các tỉnh lỵ Thái Bình, Khánh Hòa. Tại Hà Nội, ngày 17/8 Việt Minh đã biến cuộc mít tinh ủng hộ chính phủ Trần Trọng Kim thành cuộc biểu dương lực lượng cách mạng của quần chúng.
...
Tại Khánh Hòa, ngày 16/8 huyện Vạn Ninh giành được chính quyền; ngày 17/8 huyện Diên Khánh; ngày 19/8 huyện Vĩnh Xương và thị xã Nha Trang; ngày 22/8 huyện Cam Ranh giành được chính quyền.`,
    ...
    {
        date: '20/8/1945',
        content: `Tổng khởi nghĩa giành chính quyền ở các tỉnh Thanh Hóa, Bắc Ninh, Thái Nguyên, Ninh Bình, Sơn Tây, Yên Bái. Tại Thanh Hóa, ngày 19/8 các huyện Thiệu Hóa, Thọ Xuân, Cẩm Thủy giành được chính quyền; ngày 20/8 giành chính quyền ở thị xã Thanh Hóa; ngày 21/8 ở huyện Tĩnh Gia, Nông Cống. Tại Bắc Ninh, ngày 17/8 huyện Tiên Du giành được chính quyền; ngày 18/8 huyện Lang Tài, Võ Giàng; ngày 19/8 huyện Yên Phong; ngày 20/8 thị xã Bắc Giang và huyện Thuận Thành giành chính quyền thắng lợi; ngày 21/8 huyện Văn Giang; ngày 22/8 huyện Quế Dương.Tại Thái Nguyên, từ tháng 3/1945 nhiều châu huyện đã khởi nghĩa từng phần; đến tháng 8/1945 địch chỉ còn kiểm soát được châu lỵ La Hiên (Võ Nhai) và thị xã Thái Nguyên.
...
Ngày 18/8 lực lượng cách mạng tiến vào thị xã; ngày 20/8 giành được chính quyền tỉnh.`,
    ...
    {
        date: '21/8/1945',
        content: `Khởi nghĩa giành chính quyền ở tỉnh lỵ Bắc Cạn, Tuyên Quang, Nam Định, Nghệ An, Ninh Thuận, Phúc Yên. 
    ...
    {
        date: '22/8/1945',
        content: `Khởi nghĩa giành chính quyền ở các tỉnh Cao Bằng, Hưng Yên, Kiến An, Tân An.
...
Tại Tân An, ngày 22/8 giành chính quyền tại thị xã Tân An; buổi chiều khởi nghĩa thắng lợi ở các quận Châu Thành, Thủ Thừa; ngày 23/8 quận Mộc Hóa giành chính quyền.`,
    ...
    {
        date: ' 23/8/1945',
        content: `Khởi nghĩa giành chính quyền tại Thừa Thiên - Huế, Hải Phòng, Hà Đông, Hòa Bình, Quảng Bình, Bình Định, Gia Lai, Bạc Liêu, Quảng Trị, Lâm Viên.
...
Tại Hà Đông, ngày 16/8 khởi nghĩa thắng lợi ở các huyện Ứng Hòa, Mỹ Đức, Chương Mỹ; ngày 18/8 giành chính quyền ở các huyện Thanh Trì, Thanh Oai, Thường Tín, Phú Xuyên; ngày 20/8 lực lượng cách mạng nổi dậy ở thị xã, đến 23/8 hoàn toàn làm chủ được thị xã Hà Đông.`,
    ...
    {
        date: '24/8/1945',
        content: `Khởi nghĩa giành chính quyền tại các tỉnh Hà Nam, Quảng Yên, Đắk Lắk, Phú Yên, Gò Công.
...
Tại Gò Công, ngày 23/8 trước khí thế cách mạng của quần chúng, tỉnh trưởng Gò Công tự trao chính quyền cho Ủy ban dân tộc giải phóng; ngày 24/8 chính quyền cách mạng được thành lập.`,
    ...
    {
        date: '25/8/1945,',
        content: `Khởi nghĩa giành chính quyền tại thành phố Sài Gòn và các tỉnh lỵ Chợ Lớn, Gia Định, Bình Thuận, Long Xuyên, Vĩnh Long, Bà Rịa, Thủ Dầu Một, Trà Vinh, Bến Tre, Tây Ninh, Sa Đéc, Kon Tum, Lạng Sơn, Phú Thọ, Sơn La.
...
Tại Rạch Giá, ngày 27/8, 60.000 quần chúng nhân dân từ các vùng nông thôn và nhân dân thị xã được vũ trang nổi dậy khởi nghĩa giành chính quyền; sau đó các quận, huyện trong tỉnh lần lượt giành được chính quyền.`,
    ...
    {
        date: ' 28/8/1945',
        content: `Khởi nghĩa giành chính quyền tại các tỉnh lỵ Đồng Nai Thượng và Hà Tiên, cơ bản kết thúc cuộc Tổng khởi nghĩa giành chính quyền trên phạm vi cả nước.
